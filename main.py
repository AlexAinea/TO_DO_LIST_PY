...
def authentication():
    ...
    log_in_button_auth_form = tk.Button(auth,text="LOG IN",bg="white",fg="black",activebackground="white",activeforeground="black",highlightbackground="#87CEEB",highlightthickness="0",padx=10, pady=4, cursor="hand2")
    log_in_button_auth_form.grid(padx= 150,pady=150, row=0, column=0)

    sign_up_button_auth_form = tk.Button(auth,text="SIGN UP",bg="white",fg="black",activebackground="white",activeforeground="black",highlightbackground="#87CEEB",highlightthickness="0",padx=10, pady=4, cursor="hand2")
    sign_up_button_auth_form.grid(row=0, column=1)
    ...
    def log_in_function():
        ...
        username_log_in_entry = tk.Entry(log_in_frame, bg="#87CEEB", fg="black", bd=0, highlightthickness = 1, relief="flat", borderwidth=0)
